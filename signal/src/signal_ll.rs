// use super::{Channel, ChannelId, GroupData, Message};
...
//     }
//
//     pub fn send_reaction(&self, channel: &Channel, message: &Message, emoji: String, remove: bool) {
//         let timestamp = utc_now_timestamp_msec();
...
//     }
//
//     pub async fn contact_name(&self, id: Uuid, profile_key: [u8; 32]) -> Option<String> {
...
//     let device_name = format!("kamel{}", at_hostname);
